...
const TransactionBox = ({ domainName, price }) => {
    ...
    return (
        <div>
            ...
            <div className='w-full h-[400px] lg:h-fit relative'>
                <div className='trans-box w-[90%] h-fit lg:w-[400px] bg-white absolute top-[15rem] left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-lg lg:left-[77.5%] top-[7rem] lg:top-[-0.7rem]'>
                    
                    {/* Top Text */}
                    <div className='p-4 flex flex-col gap-4'>
                        <p className='text-[25px] font-semibold'>Get this domain</p>
                        <div className='flex items-center gap-3'>
                            <p className='w-fit text-[12px] font-medium py-1 px-2 rounded-md bg-[#d3c1f7] flex items-center gap-0.5'>
                                <IoDiamondOutline /> PREMIUM
                            </p>
                            <p className='w-fit text-[12px] font-medium py-1 px-2 rounded-md bg-[#a6fff8] flex items-center gap-0.5'>
                                <IoCheckmarkCircleOutline /> VERIFIED DOMAIN
                            </p>
                        </div>
                        <p>Own it today for ${price} and make it yours.</p>
                    </div>
                    {/* End of Top Text */}
                    ...
                    <section className='w-full h-[70px] bg-[#f5f5f5] border-[1px] border-gray-200 flex items-center'>
                        <div className='w-[90%] my-0 mx-auto flex items-center justify-between'>
                            <div className='flex items-center gap-2'>
                                <input type="radio" className='custom-eye-radio' defaultChecked />
                                <p className='text-[16px] font-semibold'>Buy now</p>
                            </div>
                            <p className='text-[17px] font-semibold text-[#00a4a6]'>USD ${price}</p>
                        </div>
                    </section>
                    {/* End of Buy now */}
                    ...
                    {isLoading && (
                        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center rounded-md bg-white/80">
                            <div className="relative py-4 px-8 bg-white shadow-3xl rounded-lg">
                                {/* The spinner */}
                                <div className="w-8 h-8 border-4 border-gray-200 border-t-teal-500 rounded-full animate-spin"></div>
                                <p className="text-sm text-gray-800 mt-2">Processing...</p>
                            </div>
                        </div>
                    )}
                    {/* End of Loading Card */}
